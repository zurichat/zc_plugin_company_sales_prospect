...
export const AddUserModal = () => {
	...
	const addMembersEvent = (members) => {
		customAxios
			.post(
				`/org/6153d9c4a999ef8386e80804/room/615832ad87540d8d01ffc700/members/`,
				{
			...
			.then((r) => {
				...
				customAxios
					.get("/org/6153d9c4a999ef8386e80804/room/615832ad87540d8d01ffc700")
					.then((r) => {
	...
	return (
		<div>
			...
			<Parcel config={RoomModal} wrapWith='div' parcelConfig={_config} />
		</div>
	);
};
...
export const RemoveUserModal = () => {
	...
	const removeFunction = (id) => {
		customAxios
			.post(
				`/org/6153d9c4a999ef8386e80804/room/615832ad87540d8d01ffc700/members/${id}`,
				{
					room_id: "615832ad87540d8d01ffc700",
					members_id: [id],
				}
